class Api::V1::OrdersController < ApplicationController
    ...
    def create
        ...
        if order.save
          ...
          render json: { message: 'There was an error creating the order.', errors: order.errors }, status: :unprocessable_entity
        end
      end
    ...
    private
      ...
      def order_params
        params.require(:order).permit(:order_date, :total_amount, :status, order_items_attributes: [:product_id, :quantity])
      end
  end
